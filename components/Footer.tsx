...
import { Github, Mail, Linkedin, ArrowUpRight, MessageCircle } from "lucide-react";
    ...
    <footer id="contact" className="py-24 px-6 bg-black border-t border-white/10">
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <a
            href="https://github.com/justinjengelberts-web"
            target="_blank"
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://www.linkedin.com/in/justin-engelberts/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 text-zinc-400 hover:text-white transition-colors"
                aria-label="LinkedIn"
              ...
              <a
                href="https://wa.me/31653991168"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 bg-emerald-500/20 backdrop-blur-sm border border-emerald-500/30 rounded-lg text-emerald-400 hover:bg-emerald-500/30 hover:text-emerald-300 transition-all"
                aria-label="WhatsApp"
              >
